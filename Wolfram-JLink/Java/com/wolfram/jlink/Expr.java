...
public final class Expr implements Serializable, Iterable<Expr> {
    ...
    private static final int INTARRAY3  = 204;
    private static final int REALARRAY3 = 205;
    private static final int BYTEARRAY1 = 206;
    private static final int BYTEARRAY2 = 207;
    private static final int BYTEARRAY3 = 208;
    private static final int SHORTARRAY1 = 209;
    private static final int SHORTARRAY2 = 210;
    private static final int SHORTARRAY3 = 211;
    private static final int LONGARRAY1  = 212;
    private static final int LONGARRAY2  = 213;
    private static final int LONGARRAY3  = 214;
	...
	public Expr(int type, String val) {
	    ...
	    if (val == null)
	        throw new IllegalArgumentException("Cannot create an Expr with a null value");
    ...
    /**
     * Creates an Expr representing a Mathematica list of bytes with the specified value.
     * The values are converted to unsigned bytes when written to a link (so that this represents the common
     * Mathematica NumericArray["UnsignedInteger8"] or ByteArray type).
     * 
     * @param val
     */
    ...
    /**
     * Creates an Expr representing a Mathematica list of short integers with the specified value.
     * 
     * @param val
     */
    ...
    /**
     * Creates an Expr representing a Mathematica matrix of bytes with the specified value.
     * 
     * @param val
     */
    ...
    public Expr(byte[][] val) {
        ...
        this.type = BYTEARRAY2;
        this.head = SYM_LIST;
        this.val = new byte[val.length][];
        for (int i = 0; i < val.length; i++)
            ((byte[][])this.val)[i] = (byte[]) val[i].clone();
    }

    /**
     * Creates an Expr representing a Mathematica matrix of short integers with the specified value.
     * 
     * @param val
     */
    ...
    public Expr(short[][] val) {
        ...
        this.type = SHORTARRAY2;
        this.head = SYM_LIST;
        this.val = new short[val.length][];
        for (int i = 0; i < val.length; i++)
            ((short[][])this.val)[i] = (short[]) val[i].clone();
    }
    ...
    public Expr(long[][] val) {
        ...
        this.type = LONGARRAY2;
        this.head = SYM_LIST;
        this.val = new long[val.length][];
        for (int i = 0; i < val.length; i++)
            ((long[][])this.val)[i] = (long[]) val[i].clone();
    }
    ...
    /**
     * Creates an Expr representing a depth-3 Mathematica array of bytes with the specified value.
     * 
     * @param val
     */
    ...
    public Expr(byte[][][] val) {
        ...
        this.type = BYTEARRAY3;
        this.head = SYM_LIST;
        byte[][][] ba = new byte[val.length][][];
        for (int i = 0; i < val.length; i++) {
            ba[i] = new byte[val[i].length][];
            for (int j = 0; j < val[i].length; j++)
                ba[i][j] = Arrays.copyOf(val[i][j], val[i][j].length);
        }
        this.val = ba;
    }

    /**
     * Creates an Expr representing a depth-3 Mathematica array of short integers with the specified value.
     * 
     * @param val
     */
    ...
    public Expr(short[][][] val) {
        ...
        this.type = SHORTARRAY3;
        this.head = SYM_LIST;
        short[][][] a = new short[val.length][][];
        for (int i = 0; i < val.length; i++) {
            a[i] = new short[val[i].length][];
            for (int j = 0; j < val[i].length; j++)
                a[i][j] = Arrays.copyOf(val[i][j], val[i][j].length);
        }
        this.val = a;
    }

    /**
     * Creates an Expr representing a depth-3 Mathematica array of integers with the specified value.
     * 
     * @param val
     */
    ...
    public Expr(int[][][] val) {
        ...
        this.type = INTARRAY3;
        this.head = SYM_LIST;
        int[][][] ia = new int[val.length][][];
        for (int i = 0; i < val.length; i++) {
            ia[i] = new int[val[i].length][];
            for (int j = 0; j < val[i].length; j++)
                ia[i][j] = Arrays.copyOf(val[i][j], val[i][j].length);
        }
        this.val = ia;
    }
    ...
    public Expr(long[][][] val) {
        ...
        this.type = LONGARRAY3;
        this.head = SYM_LIST;
        long[][][] ia = new long[val.length][][];
        for (int i = 0; i < val.length; i++) {
            ia[i] = new long[val[i].length][];
            for (int j = 0; j < val[i].length; j++)
                ia[i][j] = Arrays.copyOf(val[i][j], val[i][j].length);
        }
        this.val = ia;
    ...
    /**
     * Creates an Expr representing a depth-3 Mathematica array of reals with the specified value.
     * 
     * @param val
     */
    ...
    public Expr(double[][][] val) {
        ...
        this.type = REALARRAY3;
        this.head = SYM_LIST;
        double[][][] da = new double[val.length][][];
        for (int i = 0; i < val.length; i++) {
            da[i] = new double[val[i].length][];
            for (int j = 0; j < val[i].length; j++)
                da[i][j] = Arrays.copyOf(val[i][j], val[i][j].length);
        }
        this.val = da;
    }
     ...
     * @param args an array or sequence of Exprs giving the arguments of this Expr; pass null or leave empty for no arguments
	 */
     ...
     * Creates an Expr with the given head and arguments.
     * 
     * @param head a String giving the head of this Expr as a symbol name
     * @param args an array or sequence of Exprs giving the arguments of this Expr; pass null or leave empty for no arguments
     */
       
	public Expr(String head, Expr ... args) {
	    this(new Expr(head), args);
	}
	...
	public boolean equals(Object obj) {
		...
		if (val != null) {
			...
			switch (type) {
                ...
                case BYTEARRAY1:
                    return Arrays.equals((byte[]) val, (byte[]) otherExpr.val);
                case SHORTARRAY1:
                    return Arrays.equals((short[]) val, (short[]) otherExpr.val);
                case INTARRAY1:
                    return Arrays.equals((int[]) val, (int[]) otherExpr.val);
                case LONGARRAY1:
                    return Arrays.equals((long[]) val, (long[]) otherExpr.val);
				case REALARRAY1: 
                    return Arrays.equals((double[]) val, (double[]) otherExpr.val);
                case BYTEARRAY2:
                case SHORTARRAY2: 
                case INTARRAY2: 
                case LONGARRAY2: 
                ...
                case LONGARRAY3: 
                case REALARRAY3:
                    return Arrays.deepEquals((Object[]) val, (Object[]) otherExpr.val);
				default:
	...
	public int hashCode() {
		...
		if (val != null) {
			if (type < FIRST_ARRAY_TYPE) {
            ...
            } else if (type == BYTEARRAY1) {
                hash = Arrays.hashCode((byte[]) val);
            } else if (type == SHORTARRAY1) {
                hash = Arrays.hashCode((short[]) val);
            } else if (type == INTARRAY1) {
                hash = Arrays.hashCode((int[]) val);
            } else if (type == LONGARRAY1) {
                hash = Arrays.hashCode((long[]) val);
			} else if (type == REALARRAY1) {
                hash = Arrays.hashCode((double[]) val);
            } else if (type == BYTEARRAY2) {
                byte[][] iaa = (byte[][]) val;
                for (int i = 0; i < iaa.length; i++) {
                    hash += Arrays.hashCode(iaa[i]);
                }
            } else if (type == SHORTARRAY2) {
                short[][] iaa = (short[][]) val;
                for (int i = 0; i < iaa.length; i++) {
                    hash += Arrays.hashCode(iaa[i]);
                }
                ...
                for (int i = 0; i < daa.length; i++) {
                    hash += Arrays.hashCode(daa[i]);
                }
            } else if (type == BYTEARRAY3) {
                byte[][][] aaa = (byte[][][]) val;
                for (int i = 0; i < aaa.length; i++) {
                    byte[][] aa = aaa[i];
                    for (int j = 0; j < aa.length; j++) {
                        hash += Arrays.hashCode(aa[j]);
                   }
                }
            } else if (type == SHORTARRAY3) {
                short[][][] aaa = (short[][][]) val;
                for (int i = 0; i < aaa.length; i++) {
                    short[][] aa = aaa[i];
                    for (int j = 0; j < aa.length; j++) {
            ...
            } else if (type == REALARRAY3) {
                double[][][] aaa = (double[][][]) val;
                for (int i = 0; i < aaa.length; i++) {
                    double[][] aa = aaa[i];
                    for (int j = 0; j < aa.length; j++) {
                        hash += Arrays.hashCode(aa[j]);
	 ...
	 * Mathematica function Dimensions. Assumes the array is rectangular.
	 * 
		...
		if (type < FIRST_COMPOSITE) {
			...
			switch (type) {
                ...
                case BYTEARRAY2:
                    dims = new int[2];
                    dims[0] = Array.getLength(val);
                    dims[1] = ((byte[][])val)[0].length;
                    break;
                case SHORTARRAY2:
                    dims = new int[2];
                    dims[0] = Array.getLength(val);
                    dims[1] = ((short[][])val)[0].length;
                    break;
                case INTARRAY2:
                    dims = new int[2];
                    dims[0] = Array.getLength(val);
                ...
                case BYTEARRAY3:
                    ...
                    dims[0] = Array.getLength(val);
                    dims[1] = ((byte[][][])val)[0].length;
                    dims[2] = ((byte[][][])val)[0][0].length;
                    break;
                case SHORTARRAY3:
                    dims = new int[3];
                    dims[0] = Array.getLength(val);
                    dims[1] = ((short[][][])val)[0].length;
                    dims[2] = ((short[][][])val)[0][0].length;
                    break;
                case INTARRAY3:
                    dims = new int[3];
                    dims[0] = Array.getLength(val);
                    dims[1] = ((int[][][])val)[0].length;
                    dims[2] = ((int[][][])val)[0][0].length;
                    break;
                case LONGARRAY3:
                    dims = new int[3];
                    dims[0] = Array.getLength(val);
                    dims[1] = ((long[][][])val)[0].length;
                    dims[2] = ((long[][][])val)[0][0].length;
                    break;
                case REALARRAY3:
                    dims = new int[3];
                    dims[0] = Array.getLength(val);
                    dims[1] = ((double[][][])val)[0].length;
                    dims[2] = ((double[][][])val)[0][0].length;
                    break;
				case FUNCTION: {
					if (args.length == 0) {
						dims = new int[1];
	...
	public String toString() {
		...
		switch (type) {
            ...
            case BYTEARRAY1: {
                ...
                buf.append('{');
                for (int i = 0; i < len; i++) {
                    buf.append(String.valueOf(ba[i]));
                    if (i < len - 1)
                        buf.append(',');
                }
                buf.append('}');
            ...
            case INTARRAY1: {
                ...
                buf.append('{');
                for (int i = 0; i < len; i++) {
                    buf.append(String.valueOf(ia[i]));
                    if (i < len - 1)
                        buf.append(',');
                }
                buf.append('}');
			...
			case REALARRAY1: {
				...
				buf.append('{');
				for (int i = 0; i < len; i++) {
					buf.append(doubleToInputFormString(da[i]));
					if (i < len - 1)
						buf.append(',');
				}
				buf.append('}');
            ...
            case BYTEARRAY2: {
                ...
                byte[][] ba = (byte[][]) val;
                StringBuffer buf = new StringBuffer(len1 * len2 * 3);
                buf.append('{');
                for (int i = 0; i < len1; i++) {
                    buf.append('{');
                    for (int j = 0; j < len2; j++) {
                        buf.append(String.valueOf(ba[i][j]));
                        if (j < len2 - 1)
                            buf.append(',');
                    }
                    buf.append(i < len1 - 1 ? "}," : "}");
            ...
            case INTARRAY2: {
                ...
                int len2 = Array.getLength(Array.get(val, 0));
                int[][] ia = (int[][]) val;
                StringBuffer buf = new StringBuffer(len1 * len2 * 4);
                buf.append('{');
                for (int i = 0; i < len1; i++) {
                    buf.append('{');
                    for (int j = 0; j < len2; j++) {
                        buf.append(String.valueOf(ia[i][j]));
                        if (j < len2 - 1)
                            buf.append(',');
                    }
                    buf.append(i < len1 - 1 ? "}," : "}");
			...
			case REALARRAY2: {
				...
				for (int i = 0; i < len1; i++) {
					buf.append('{');
					for (int j = 0; j < len2; j++) {
						buf.append(doubleToInputFormString(da[i][j]));
						if (j < len2 - 1)
							buf.append(',');
					}
					buf.append(i < len1 - 1 ? "}," : "}");
            ...
            case BYTEARRAY3: {
                int len1 = Array.getLength(val);
                int len2 = Array.getLength(Array.get(val, 0));
                int len3 = Array.getLength(Array.get(Array.get(val, 0), 0));
                byte[][][] ba = (byte[][][]) val;
                StringBuffer buf = new StringBuffer(len1 * len2 * len3 * 3);
                buf.append('{');
                for (int i = 0; i < len1; i++) {
                    buf.append('{');
                    for (int j = 0; j < len2; j++) {
                        ...
                        for (int k = 0; k < len3; k++) {
                            buf.append(String.valueOf(ba[i][j][k]));
                            if (k < len3 - 1)
                                buf.append(',');
                        }
                        buf.append(j < len2 - 1 ? "}," : "}");
            ...
            case INTARRAY3: {
                ...
                int len3 = Array.getLength(Array.get(Array.get(val, 0), 0));
                int[][][] ia = (int[][][]) val;
                StringBuffer buf = new StringBuffer(len1 * len2 * len3 * 4);
                buf.append('{');
                for (int i = 0; i < len1; i++) {
                    buf.append('{');
                    for (int j = 0; j < len2; j++) {
                        buf.append('{');
                        for (int k = 0; k < len3; k++) {
                            buf.append(String.valueOf(ia[i][j][k]));
                            if (k < len3 - 1)
                                buf.append(',');
                        }
                        buf.append(j < len2 - 1 ? "}," : "}");
            ...
            case REALARRAY3: {
                ...
                for (int i = 0; i < len1; i++) {
                    ...
                    for (int j = 0; j < len2; j++) {
                        buf.append('{');
                        for (int k = 0; k < len3; k++) {
                            buf.append(doubleToInputFormString(da[i][j][k]));
                            if (k < len3 - 1)
                                buf.append(',');
                        }
                        buf.append(j < len2 - 1 ? "}," : "}");
	...
	public boolean vectorQ() {
		...
		prepareFromLoopback();
		if (type == BYTEARRAY1 || type == SHORTARRAY1 || type == INTARRAY1 || type == LONGARRAY1 || type == REALARRAY1)
			return true;
		if (type == BYTEARRAY2 || type == SHORTARRAY2 || type == INTARRAY2 || type == LONGARRAY2 || type == REALARRAY2 || 
		        type == BYTEARRAY3 || type == SHORTARRAY3 || type == INTARRAY3 || type == LONGARRAY3 || type == REALARRAY3 || !listQ())
			return false;
	...
	public boolean matrixQ() {
		...
		if (type == BYTEARRAY2 || type == SHORTARRAY2 || type == INTARRAY2 || type == LONGARRAY2 || type == REALARRAY2)
			return true;
		if (type == BYTEARRAY1 || type == SHORTARRAY1 || type == INTARRAY1  || type == LONGARRAY1 || type == REALARRAY1 || 
		        type == BYTEARRAY3 || type == INTARRAY3 || type == LONGARRAY3 || type == REALARRAY3 || !listQ())
			return false;
		// No need to force cache filling (by calling nonCopyingArgs()), since I've already ruled out the types
		// where the args field wouldn't have been filled.
		if (args.length == 0)
	...
	public boolean matrixQ(int eType) {
		...
		if (!matrixQ())
			return false;
		if (eType == INTEGER && (type == BYTEARRAY2 || type == SHORTARRAY2 || type == INTARRAY2 || type == LONGARRAY2) ||
	 ...
	 * type must be either INTEGER or REAL, and the current maximum depth is 3. It will throw a
	 ...
	 * @exception IllegalArgumentException if type is not INTEGER or REAL, or depth > 3
	 * @see #asInt()
	 * @see #asDouble()
	 * @see #asString()
	 */
	...
	public Object asArray(int reqType, int depth) throws ExprFormatException {
		...
		prepareFromLoopback();
		if (depth > 3)
			throw new IllegalArgumentException("Depths > 3 are not supported in Expr.asArray()");
		...
		switch (type) {
            case BYTEARRAY1: {
                ...
                return (byte[]) ((byte[]) val).clone();
            }
            case SHORTARRAY1: {
                if (depth != 1 || reqType != INTEGER)
                    throw new ExprFormatException("This Expr is of type " + typeToString() + " and cannot be represented as a Java array of the requested type and depth");
                // Note the defensive copying of arrays to preserve immutability of Exprs (item 24 in "Effective Java").
                return (short[]) ((short[]) val).clone();
            }
            case INTARRAY1: {
                if (depth != 1 || reqType != INTEGER)
                    throw new ExprFormatException("This Expr is of type " + typeToString() + " and cannot be represented as a Java array of the requested type and depth");
            ...
            case BYTEARRAY2: {
                if (depth != 2 || reqType != INTEGER)
                    throw new ExprFormatException("This Expr is of type " + typeToString() + " and cannot be represented as a Java array of the requested type and depth");
                byte[][] ia = new byte[((byte[][]) val).length][];
                for (int i = 0; i < ia.length; i++)
                    ia[i] = (byte[]) ((byte[][]) val)[i].clone();
                return ia;
            }
            case SHORTARRAY2: {
                if (depth != 2 || reqType != INTEGER)
                    throw new ExprFormatException("This Expr is of type " + typeToString() + " and cannot be represented as a Java array of the requested type and depth");
                short[][] ia = new short[((short[][]) val).length][];
                for (int i = 0; i < ia.length; i++)
                    ia[i] = (short[]) ((short[][]) val)[i].clone();
                return ia;
            }
            case INTARRAY2: {
                if (depth != 2 || reqType != INTEGER)
            ...
            case LONGARRAY2: {
                if (depth != 2 || reqType != INTEGER)
                    throw new ExprFormatException("This Expr is of type " + typeToString() + " and cannot be represented as a Java array of the requested type and depth");
                long[][] ia = new long[((long[][]) val).length][];
                for (int i = 0; i < ia.length; i++)
                    ia[i] = (long[]) ((long[][]) val)[i].clone();
                return ia;
            }
			case REALARRAY2: {
            ...
            case BYTEARRAY3: {
                if (depth != 3 || reqType != INTEGER)
                    throw new ExprFormatException("This Expr is of type " + typeToString() + " and cannot be represented as a Java array of the requested type and depth");
                int len1 = Array.getLength(val);
                int len2 = Array.getLength(Array.get(val, 0));
                byte[][][] ba = new byte[len1][len2][];
                for (int i = 0; i < len1; i++)
                    for (int j = 0; j < len2; j++)
                        ba[i][j] = (byte[]) ((byte[][][]) val)[i][j].clone();
                return ba;
            }
            case SHORTARRAY3: {
                if (depth != 3 || reqType != INTEGER)
                ...
                int len1 = Array.getLength(val);
                int len2 = Array.getLength(Array.get(val, 0));
                short[][][] ba = new short[len1][len2][];
                for (int i = 0; i < len1; i++)
                    for (int j = 0; j < len2; j++)
                        ba[i][j] = (short[]) ((short[][][]) val)[i][j].clone();
                return ba;
            }
            case INTARRAY3: {
                if (depth != 3 || reqType != INTEGER)
                ...
                int len1 = Array.getLength(val);
                int len2 = Array.getLength(Array.get(val, 0));
                int[][][] ia = new int[len1][len2][];
                for (int i = 0; i < len1; i++)
                    for (int j = 0; j < len2; j++)
                        ia[i][j] = (int[]) ((int[][][]) val)[i][j].clone();
                return ia;
            }
            case LONGARRAY3: {
                if (depth != 3 || reqType != INTEGER)
                ...
                int len1 = Array.getLength(val);
                int len2 = Array.getLength(Array.get(val, 0));
                long[][][] ia = new long[len1][len2][];
                for (int i = 0; i < len1; i++)
                    for (int j = 0; j < len2; j++)
                        ia[i][j] = (long[]) ((long[][][]) val)[i][j].clone();
                return ia;
            }
            case REALARRAY3: {
                if (depth != 3 || reqType != REAL)
                    throw new ExprFormatException("This Expr is of type " + typeToString() + " and cannot be represented as a Java array of the requested type and depth");
                int len1 = Array.getLength(val);
                int len2 = Array.getLength(Array.get(val, 0));
                double[][][] da = new double[len1][len2][];
                for (int i = 0; i < len1; i++)
                    for (int j = 0; j < len2; j++)
                        da[i][j] = (double[]) ((double[][][]) val)[i][j].clone();
                return da;
            }
			case FUNCTION: {
				if (depth == 1) {
	...
	/** Provides an {@link Iterator} to traverse this expression's arguments.
	 */
	@Override
