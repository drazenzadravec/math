 ...
 *  <td valign="top">The path to the Wolfram kernel to launch</td>
 *  <td valign="top" align="center">Either exe or cmdline must be specified</td>
 * </tr>
 * <tr>
 *  <td valign="top">args</td>
 *  <td valign="top">Non-MathLink command-line arguments to pass to the Wolfram kernel. Used only with the exe attribute.</td>
 ...
 * <pre>
 * &lt;!-- Windows --&gt;
 * &lt;property name="mathExe", value="c:/program files/wolfram research/mathematica/12.2/mathkernel"/&gt;
 *
 * &lt;!-- Linux, Unix ('math' is typically on PATH) --&gt;
 * &lt;property name="mathExe", value="math"/&gt;
 *
 * &lt;!-- Mac OS/X --&gt;
 * &lt;property name="mathExe", value="/Applications/Mathematica.app/Contents/MacOS/MathKernel"/&gt;</pre>
 *
...
public class MathematicaTask extends Task implements PacketListener {
    ...
    // Non-MathLink command-line args to pass to the kernel. Used only with the 'exe' attribute.
    ...
    protected KernelLink initKernel() {
        ...
        KernelLink ml = null;
        ArrayList<String> kernelArgs = new ArrayList<String>();
        boolean useArray = false;

        if (exe != null) {
            useArray = true;
            String quoteChar = Utils.isWindows() ? "" : "'";
            kernelArgs.add("-linkmode");
            kernelArgs.add("launch");
            kernelArgs.add("-linkname");
            kernelArgs.add(quoteChar + exe + quoteChar + " -mathlink");
            if (args != null) {
        ...
        try {
            if (useArray) {
                ...
                ml = MathLinkFactory.createKernelLink(kernelArgs.toArray(new String[kernelArgs.size()]));
                ml.discardAnswer();
            } else {
            ...
            throw new BuildException("Failed to launch or connect to Wolfram kernel: " + e.getMessage(), e, getLocation());
        }
        return ml;
    }
