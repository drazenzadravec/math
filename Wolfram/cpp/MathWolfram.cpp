...
//
//	// WSTP Open a connection to the wolfram kernel
//	link = WSOpenString(env, "-linkmode launch \"C:\\Program Files\\Wolfram Research\\Wolfram Engine\\13.0\\MathKernel.exe\"", &error);
//	if (link == (WSLINK)0 || error != WSEOK)
//	{
//		std::cout << "Unable to create link";
//		return 1;
...
//		std::string Head = inputPacketFunction.getHead();
//		int ArgCount = inputPacketFunction.getArgc();
//		std::cout << "-->> Function head:" << Head << " Arguments :" << ArgCount << std::endl;
//		if (ArgCount < 10)
//		{
//			for (int i = 0; i < ArgCount; i++)
//			{
